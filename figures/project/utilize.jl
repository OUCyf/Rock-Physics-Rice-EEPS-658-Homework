...
function comp_grid(n0, n1, h, hy, nt, dt)
    n = (Integer(n0),Integer(n1))
    return comp_grid(n, Float64(h), Float64(hy), Integer(nt), Float64(dt))
end
...
function patchy(sw::Array{T1, 3}, vp::Matrix{T}, rho::Matrix{T}, phi::Matrix{T}, d1, d2; bulk_fl1 = 2.735f9, bulk_fl2 = 0.125f9,ρw = 7.766f2, ρo = 1.053f3) where {T1, T}
    d = (d1,d2)
